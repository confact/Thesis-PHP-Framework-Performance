...
\end{abstract}
\section{Intro}
\TODO{Need to rewrite this to take up the context and more like that, also the connection to other work in the same area, which doesn't exist. but need to tell that.}
