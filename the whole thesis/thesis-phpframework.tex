...
Evaluation in web is mostly done by load testing and counted in ms, but also by TPS (Tin how to optimize the page itself to minimize request to server, like less pictures, or move them to another server. 
...
\begin{tabular}{ p{3cm} p{7cm} }
  	...
  	Response size & constant. See the size in table \ref{table:controlledvariables}.
\end{tabular}
