...
If using many images, the browser first loads the page and then send request to get the images and scripts on the page, adding more load to the server, 
...
The selection was not so hard. Looked for data that was something about evaluation in this area, and it was a few. 
