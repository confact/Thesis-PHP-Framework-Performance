...
{\bf [Problem]} .... \todo{this need to be written.}
...
\end{abstract}
\section{Intro}
\todo{Need to rewrite this to take up the context and more like that, also the connection to other work in the same area, which doesn't exist. but need to tell that.}
...
\subsection{MVC}
\todo[inline]{need to write more in detail about MVC here.}Model View Controller is a structure-think to have 3 different types of classes, types of what they will do. \cite{MVC:phpTeam} 
...
\todo{Need to rewrite this, adding more data why this is not covered.}
