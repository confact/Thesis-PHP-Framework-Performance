...
{\bf [Problem]} Visitors nowadays has less thought to wait for a web page to load. Same time has PHP Framework become popular among developers, except they have not thought about performance. Making it a good idea to try to discovery how the performance is for PHP Framework for a visitor.
...
The websites exploded in amount and it started to be some request to save information and to do something more than show static pages and files for the user. 
...
It is a big area in performance in php framework that is not covered.
\newpage
